...
val employeesListSortedByBirthdayDateExample = listOf(
    Employee(
    ...
    Employee(
        employeeId = "e0fceffa-cef3-45f7-97c6-6be2e3705927",
        employeeAvatarUrl = "https://cdn.fakercloud.com/avatars/marrimo_128.jpg",
        employeeFirstName = "Dee",
        employeeLastName = "Reichert",
        employeeUserTag = "LK",
        employeeDepartmentName = "back_office",
        employeePosition = "Technician",
        employeeBirthdayDate = "2004-08-02",
        employeePhoneNumber = "802-623-1785"
    ),
    Employee(
        employeeId = "514bec78-d65d-4140-81d7-e23fb3fc3ba8",
        employeeAvatarUrl = "https://cdn.fakercloud.com/avatars/vitorleal_128.jpg",
        employeeFirstName = "Hanna",
        employeeLastName = "Kling",
        employeeUserTag = "PY",
        employeeDepartmentName = "android",
        employeePosition = "Strategist",
        employeeBirthdayDate = "1994-12-17",
        employeePhoneNumber = "980-962-6297"
    )
)